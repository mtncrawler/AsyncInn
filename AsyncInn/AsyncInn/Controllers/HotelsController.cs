...
namespace AsyncInn.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Street,City,State,ZipCode,Phone")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Street,City,State,ZipCode,Phone")] Hotel hotel)
        {
            if (id != hotel.ID)
            {
                return NotFound();
